...
public class ContactControllerTest {
    ...
    void createContactSuccess() throws Exception{
        ...
        request.setLastName("Berry");
        request.setEmail("dade@example.com");
        request.setPhone("23345454545");
        ...
        mockMvc.perform(
           ...
           assertEquals("Dade", response.getData().getFirstName());
           assertEquals("Berry", response.getData().getLastName());
           assertEquals("dade@example.com", response.getData().getEmail());
           assertEquals("23345454545", response.getData().getPhone());
    ...
    void getContactSuccess() throws Exception{
        ...
        contact.setFirstName("Dade");
        contact.setLastName("Berry");
        contact.setEmail("dade@example.com");
        contact.setPhone("2134435456");
